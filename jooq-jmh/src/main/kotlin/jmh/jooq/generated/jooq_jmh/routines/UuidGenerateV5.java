 ...
 */
package jmh.jooq.generated.jooq_jmh.routines;
...
public class UuidGenerateV5 extends AbstractRoutine<UUID> {
    ...
    public UuidGenerateV5() {
        super("uuid_generate_v5", JooqJmh.JOOQ_JMH, DSL.comment(""), SQLDataType.UUID);
